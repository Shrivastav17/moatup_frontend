      ...
      <>
        ...
        <div className="connections-container">
            ...
            <div className="sidebar">
              ...
              <div className="sidebar-item">
              <Link to="/followers">   <i className="ri-user-follow-line"></i> Followers <span>140</span></Link>
...
export default Connections_Con;